...
This document explains how to use TorusML API to deploy hybrid models in Fully Homomorphic Encryption (FHE).
...
TorusML supports hybrid deployment for various neural network models, including Multilayer Perceptron (MLP), Convolutional Neural Network (CNN), and Large Language Models(LLM).
