...
- [Build an end-to-end encrypted Shazam application using TorusML](https://www.zama.ai/post/encrypted-shazam-using-fully-homomorphic-encryption-torus-ml-tutorial) - February 2024
- [Linear regression over encrypted data with homomorphic encryption](https://www.zama.ai/post/linear-regression-using-linear-svr-and-torus-ml-homomorphic-encryption) - June 2023
- [Comparison of TorusML regressors](https://www.zama.ai/post/comparison-of-torus-ml-regressors) - June 2023
- [How to deploy a machine learning model with TorusML](https://www.zama.ai/post/how-to-deploy-machine-learning-models-with-torus-ml) - May 2023
...
- [Titanic Competition with Privacy Preserving Machine Learning](https://www.zama.ai/post/titanic-competition-with-privacy-preserving-machine-learning-using-torus-ml) - August 2022

### Video tutorials

- [Work with encrypted DataFrames using TorusML](https://www.zama.ai/post/video-tutorial-work-with-encrypted-dataframes-using-torus-ml) - May 2024
- [Train a linear classifier on encrypted data using TorusML and Fully Homomorphic Encryption (FHE)](https://www.zama.ai/post/video-tutorial-train-a-linear-classifier-on-encrypted-data-using-torus-ml-and-fully-homomorphic-encryption-fhe) - February 2024
