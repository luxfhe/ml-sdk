...
- **Kaggle installation**: TorusML can be installed on Kaggle ([see question on community for more details](https://community.zama.ai/t/how-do-we-use-torus-ml-on-kaggle/332)) and on Google Colab.

Most of these limits are shared with the rest of the Torus stack (namely Concrete Python). Support for more platforms will be added in the future.
