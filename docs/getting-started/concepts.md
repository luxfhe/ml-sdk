...
1. [Lifecycle of a TorusML model](#lifecycle-of-a-torus-ml-model)
...
For a deeper understanding of the cryptography behind the Torus stack, refer to the [whitepaper on TFHE and Programmable Boostrapping](https://whitepaper.zama.ai/) or [this series of blogs](https://www.zama.ai/post/tfhe-deep-dive-part-1).
...
2. _Lux-FHE radix_ ciphertexts:
   ...
   TorusML also supports \_Lux-FHE radix _ ciphertexts, which rely on a universal and forward-compatible parameter set. Therefore:
