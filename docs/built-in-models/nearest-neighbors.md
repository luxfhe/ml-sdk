...
This document introduces the nearest neighbors non-parametric classification models that TorusML provides with a scikit-learn interface through the `KNeighborsClassifier` class.
