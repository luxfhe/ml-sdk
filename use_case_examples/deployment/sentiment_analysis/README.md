...
In this folder we show how to deploy a TorusML model that does sentiment analysis, either through Docker or Amazon Web Services.
...
1. Once that's done you can use the script provided in TorusML in `src/concrete/ml/deployment/`, use `deploy_to_docker.py`.
...
And here it is you deployed a TorusML model and ran an inference using Fully Homormophic Encryption.
