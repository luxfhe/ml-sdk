...
def get_n_bits_non_correctness(model_class):
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/3979
...
def check_double_fit(model_class, n_bits, x_1, x_2, y_1, y_2):
    ...
    if get_model_name(model_class) == "KNeighborsClassifier":
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4014
        pytest.skip(
...
def check_serialization_dump_load(model, x, use_dump_method):
    ...
    with tempfile.TemporaryFile("w+") as temp_dump:
        ...
        # FIME: https://github.com/luxfi/torusml-internal/issues/4175
...
def check_inference_methods(model, model_class, x, check_float_array_equal):
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/3373
...
def check_rounding_consistency(
    ...
    with pytest.MonkeyPatch.context() as mp_context:
        ...
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4178
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/2779
@pytest.mark.parametrize(
    "model_class, parameters",
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4169
@pytest.mark.flaky
@pytest.mark.parametrize("model_class, parameters", MODELS_AND_DATASETS)
@pytest.mark.parametrize(
...
def test_p_error_simulation(
    ...
    # FIXME https://github.com/luxfi/torusml-internal/issues/4343
    if is_linear_model:
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4179
@pytest.mark.parametrize("model_class, parameters", get_sklearn_tree_models_and_datasets())
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4234
@pytest.mark.parametrize(
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4436
@pytest.mark.parametrize(
    "model_class, parameters",
    get_sklearn_linear_models_and_datasets()
    + get_sklearn_tree_models_and_datasets()
