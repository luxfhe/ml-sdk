...
def accuracy_test_rounding(
    ...
    # Check modules predictions FHE simulation vs TorusML.
    for key, module in compiled_modules.items():

        # low bit-width rounding is not behaving as expected with new simulation
        # FIXME: https://github.com/luxfhe/torus-ml-internal/issues/4331
        if "low" not in key:
    ...
    # https://github.com/luxfhe/torus-ml-internal/issues/3662
    # mse_results = {
...
# FIXME: https://github.com/luxfhe/torus-ml-internal/issues/3429
@pytest.mark.flaky
...
# This test is a known flaky
# FIXME: https://github.com/luxfhe/torus-ml-internal/issues/3660
@pytest.mark.flaky
@pytest.mark.parametrize(
    "activation_function",
    [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # FIXME: https://github.com/luxfhe/torus-ml-internal/issues/335
        #
...
# FIXME: https://github.com/luxfhe/torus-ml-internal/issues/4578
@pytest.mark.xfail
@pytest.mark.parametrize(
...
def test_shape_operations_net(
    ...
    # FIXME: https://github.com/luxfhe/torus-ml-internal/issues/3871
...
def test_torch_padding(default_configuration, check_circuit_has_no_tlu):
    ...
    # between the torch output and the TorusML output
