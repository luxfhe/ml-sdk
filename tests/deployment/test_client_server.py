...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4460
...
# FIXME: https://github.com/luxfi/torusml-internal/issues/4737
# @pytest.mark.use_gpu
@pytest.mark.flaky
...
def test_client_server_tfhers_sklearn_inference(
    ...
    when using Lux-FHE ciphertexts for input /output."""
...
def check_client_server_inference(
    ...
    # and doesn't support lux-fhe interop
...
def test_client_server_sklearn_training(
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/4466
