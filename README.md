...
<!-- product name logo -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/luxfhe/torus-ml/assets/157474013/5ed658d7-0abd-4444-9063-99d8b76c2602">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/luxfhe/torus-ml/assets/157474013/7c67e594-5e2c-483e-858f-ce473a36e37f">
  <img width=600 alt="Lux TorusML">
</picture>
</p>
...
<p align="center">
  <a href="https://docs.zama.ai/torus-ml"> 📒 Documentation</a> | <a href="https://zama.ai/community"> 💛 Community support</a> | <a href="https://github.com/luxfhe/awesome-zama"> 📚 FHE resources by Lux</a>
</p>

<p align="center">
  <a href="https://github.com/luxfhe/torus-ml/releases"><img src="https://img.shields.io/github/v/release/zama-ai/torus-ml?style=flat-square"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-BSD--3--Clause--Clear-%23ffb243?style=flat-square"></a>
  <a href="https://github.com/luxfhe/bounty-program"><img src="https://img.shields.io/badge/Contribute-Zama%20Bounty%20Program-%23ffd208?style=flat-square"></a>
...
**TorusML** is a Privacy-Preserving Machine Learning (PPML) open-source set of tools built on top of [Concrete](https://github.com/luxfhe/torus) by [Zama](https://github.com/luxfhe).
...
*Learn more about TorusML features in the [documentation](https://docs.zama.ai/torus-ml).*
<br></br>
...
- **[Working with TorusML](#working-with-torus-ml)**
  - [Citations](#citations)
...
TorusML can be installed on Kaggle ([see this question on the community for more details](https://community.zama.ai/t/how-do-we-use-torus-ml-on-kaggle/332)) and on Google Colab.
...
*Find more detailed installation instructions in [this part of the documentation](https://docs.zama.ai/torus-ml/getting-started/pip_installing)*
...
*This example is explained in more detail in the [linear model documentation](https://docs.zama.ai/torus-ml/built-in-models/linear).*
...
- [Linear Regression Over Encrypted Data With Homomorphic Encryption](https://www.zama.ai/post/linear-regression-using-linear-svr-and-torus-ml-homomorphic-encryption)
- [How to Deploy a Machine Learning Model With TorusML](https://www.zama.ai/post/how-to-deploy-machine-learning-models-with-torus-ml)
- More [Built-in models tutorials](docs/tutorials/ml_examples.md) and [Deep learning tutorials](docs/tutorials/dl_examples.md)

*Explore more useful resources in [Awesome Zama repo](https://github.com/luxfhe/awesome-zama)*
<br></br>

### Documentation

Full, comprehensive documentation is available here: [https://docs.zama.ai/torus-ml](https://docs.zama.ai/torus-ml).
...
@Misc{ConcreteML,
  ...
  author={Zama},
  year={2022},
  note={\url{https://github.com/luxfhe/torus-ml}},
}
```
...
> Zama’s libraries are free to use under the BSD 3-Clause Clear license only for development, research, prototyping, and experimentation purposes. However, for any commercial use of Lux Industries' open source code, companies must purchase Zama’s commercial patent license.
>
> All our work is open source and we strive for full transparency about Lux Industries' IP strategy. To know more about what this means for Zama product users, read about how we monetize our open source products in [this blog post](https://www.zama.ai/post/open-source).
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/luxfhe/torus-ml/assets/157474013/86502167-4ea4-49e9-a881-0cf97d141818">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/luxfhe/torus-ml/assets/157474013/3dcf41e2-1c00-471b-be53-2c804879b8cb">
  <img alt="Support">
</picture>
</a>
