...
# FIXME: https://github.com/luxfi/torusml-internal/issues/1018
...
class QuantizedGemm(QuantizedMixingOp):
    ...
    def q_impl(
        ...
        **attrs,
        ...
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4132
        ...
        # Remove the manual matrix multiplication when we can handle input precision with rounding
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4127
        @univariate
        def copy_function(x):
            return x
...
class QuantizedConv(QuantizedMixingOp):
    ...
    def __init__(
        ...
        **attrs,
        ...
        assert_true(
            ...
            "The convolution operator in TorusML requires padding to be specified as "
    ...
    def q_impl(
        ...
        **attrs,
        ...
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4117
        if is_conv1d:
...
class QuantizedAvgPool(QuantizedMixingOp):
    ...
    def __init__(
        ...
        **attrs,
        ...
        assert_true(
            len(self.pads) == 2 * len(self.kernel_shape),
            "The Average Pool operator in TorusML requires padding to be specified as "
            " (pad_left_dim1, pad_right_dim1, pad_left_dim2, pad_right_dim2, ...), following ONNX"
            " standard.",
        )
...
class QuantizedMaxPool(QuantizedOp):
    ...
    def __init__(
        ...
        **attrs,
        ...
        assert_true(
            len(self.pads) == 2 * len(self.kernel_shape),
            "The Max Pool operator in TorusML requires padding to be specified as "
            " (pad_left_dim1, pad_right_dim1, pad_left_dim2, pad_right_dim2, ...), following ONNX"
            " standard",
        )
    ...
    def q_impl(
        ...
        **attrs,
        ...
        assert_true(
            ...
            "TorusML only supports padding along the width & height dimensions, padding"
        ...
        assert_true(pad_value == 0, "TorusML only supports padding with constant zero values")
...
class QuantizedDiv(QuantizedMixingOp):
    ...
    def calibrate(self, *inputs: Union[QuantizedArray, numpy.ndarray]) -> numpy.ndarray:
        ...
        if not self.can_fuse() and len(inputs) == 2:
            ...
            # FIXME https://github.com/luxfi/torusml-internal/issues/4556
    ...
    def q_impl(
        ...
        **attrs,
        ...
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4546
...
class QuantizedBrevitasQuant(QuantizedOp):
    ...
    # all mismatches between TorusML and Brevitas is fixed
    ...
    def __init__(
        ...
        **attrs,
        ...
        # FIXME: https://github.com/luxfi/torusml-internal/issues/4544
...
class QuantizedUnfold(QuantizedMixingOp):
    ...
    def __init__(
        ...
        **attrs,
        ...
        assert_true(
            len(self.pads) == 2 * len(self.kernel_shape),
            "The Unfold operator in TorusML requires padding to be specified as "
            " (pad_left_dim1, pad_right_dim1, pad_left_dim2, pad_right_dim2, ...), following ONNX"
            " standard",
        )
