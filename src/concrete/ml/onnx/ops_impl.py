...
def numpy_where_body(
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/2738
    return c * t + (1.0 - c) * f
...
def numpy_div(
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/857
...
def numpy_reshape(
    ...
    Returns:
        Tuple[numpy.ndarray]: Output tensor
    """
    assert_true(allowzero == 0, "TorusML currently only accepts numpy style reshape in ONNX")
    ...
    *,
    ...
    Args:
        ...
        count_include_pad (int): Whether include pad pixels when calculating values for the edges.
            Currently, setting this parameter to 0 is not supported in TorusML.
...
def numpy_reduce_sum(
    ...
    *,
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/2050
...
def numpy_gather(
    ...
    # FIXME: https://github.com/luxfi/torusml-internal/issues/3605
